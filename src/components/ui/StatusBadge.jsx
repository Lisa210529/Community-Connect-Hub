...
export default function StatusBadge({ status }) {
  const map = {
    ...
    Acknowledged: 'bg-status-completed/20 text-status-completed border-status-completed/40',
    'Submitted to Stakeholder': 'bg-status-pending/20 text-status-pending border-status-pending/40',
    Returned: 'bg-status-rejected/20 text-status-rejected border-status-rejected/40',
    Draft: 'bg-status-inactive/20 text-status-inactive border-status-inactive/40',
