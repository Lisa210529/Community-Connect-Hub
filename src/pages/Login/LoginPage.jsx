  ...
  return (
    <div className="min-h-screen bg-slate-bg flex items-center justify-center p-4">
      <div className="cyber-card w-full max-w-md shadow-glow">
        ...
        <form onSubmit={handleLogin} className="space-y-4" autoComplete="on" method="post">
          <div>
            <label className="block text-sm text-cyber-muted mb-1" htmlFor="email">
              Email
            </label>
            <input
              ref={emailRef}
          ...
          <div>
            <label className="block text-sm text-cyber-muted mb-1" htmlFor="password">
              Password
            </label>
            <input
              ref={passwordRef}
